...
func NewPrometheusRemoteWriteReceiver(params component.ReceiverCreateSettings, consumer consumer.Metrics, config *Config) (*PrometheusRemoteWriteReceiver, error) {
